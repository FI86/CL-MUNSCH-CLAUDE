...
public class API_Date {
	...
	public static void main(String[] args) {
		...
		System.out.println("nombre de jours dans le mois : " + nbJour);
		...
		System.out.println("duree entre deux horaire en heure : " + d1.toHours());
		System.out.println("duree entre deux horaire en minute : " + d1.toMinutes());
