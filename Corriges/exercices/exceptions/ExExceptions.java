...
public class ExExceptions {
    public static void main(String[] args) {
        ...
        try (Scanner clavier = new Scanner(System.in);) {
    		...
    		System.out.println("erreur avec l'entree clavier.");
    	}
        ...
        System.out.println("5 - Nombre le moins eleve : " + Collections.min(liste));
        System.out.println("6 - Nombre de nombre pairs : " + nbPair);
        System.out.println("7 - Somme des nombres impairs : " + sommeImpaire);
    }
}