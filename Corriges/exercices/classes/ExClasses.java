...
class Voiture {
    ...
    public void demarrer() {
        ...
        else System.out.println(this.id + " est deja demarree.");
    }
    ...
    public void rouler() {
        ...
        else System.out.println(this.id + " doit d'abord etre demarree.");
    }
    ...
    public void stopper() {
        ...
        else System.out.println(this.id + " doit d'abord etre demarree et rouler.");
    }
    ...
    public void arreter() {
        ...
        else System.out.println(this.id + " doit d'abord etre stoppee.");
    }
    ...
    public void infos() {
        ...
        if (this.demarrer) {
            ...
            if (this.rouler) System.out.println(this.id + " roule.");
            else System.out.println(this.id + " ne roule pas.");
        }
        else System.out.println(this.id + " est arretee.");
    }
}
