...
public class Menus {
     ...
     * @param table : nom de la table
     * @return un javaBean a creer correspondant a la table
     */
     ...
     * @return un javaBean de l'objet correspondant a creer
     */
    ...
    /**
     * Creation d'un objet saisie et valide
     * @param table : nom de la table
     */
    ...
    private static void supprimer(String table) {
        int id = Utilitaires.verifSaisieInt(new Scanner(System.in), "Entrez l'id a supprimer : ", "Erreur : Veuillez saisir un nombre entier : ");
        ...
        else System.out.println("L'id " + id + " a supprimer n'existe pas.\n");
    }
    ...
    private static void modifier(String table) {
        ...
        if (ol != null) {
            ...
            if ("".equals(erreur)) {
                ...
                if (retour) System.out.println(table + " modifie.\n");
                else System.out.println(erreur);
            }
           
        }
        else System.out.println("L'id " + id + " a modifier n'existe pas.\n");
    }
